...
- Sorted ZSTD Parquet sidecars with configurable row group size and
  compression level.
...
The committed asset bundle is intentionally small: 16 demo curated loci
...
| file                             |   bytes |   mib |
|:---------------------------------|--------:|------:|
| duckgenesnap.duckdb              | 3682304 | 3.512 |
| variant_annotations.parquet      |    6742 | 0.006 |
| genotype_interpretations.parquet |    3367 | 0.003 |
| variant_keys.parquet             |    3199 | 0.003 |
| asset_summary.parquet            |     477 | 0.000 |
| source_summary.parquet           |     481 | 0.000 |
